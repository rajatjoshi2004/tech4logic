...
const OurRangeOfWinRARServices = ({ OurRangeOfWinRARinfoData }) => {
  ...
  return (
    ...
    >
      ...
      <Grid container spacing={3} sx={{ width: "100%", ml: { xs: 0 } }}>
        {OurRangeOfWinRARinfoData?.[0]?.WinRARCardInfo?.map((card, index, array) => (
          <Grid
            item
            xs={12}
      ...
      <Box sx={{ ...styles.BottomContainerCSS, mt: { xs: "40px", md: "60px" } }}>
        ...
        >
          <Box sx={{ ...styles.leftInfo, marginBottom: { xs: "20px", md: "0" } }}>
            ...
            >
              {OurRangeOfWinRARinfoData?.[0]?.title}
            </Typography>
            <Typography
              variant="h4"
              sx={{
          ...
          <Box sx={{ ...styles.rightInfo }}>
            <Typography variant="body1" sx={styles.rightInfo["& body1"]}>
              {OurRangeOfWinRARinfoData?.[0]?.subTitle}
            </Typography>
            <Typography variant="body1" sx={styles.rightInfo["& body1"]}>
              {OurRangeOfWinRARinfoData?.[0]?.description}
            </Typography>
            <Typography variant="body1" sx={styles.rightInfo["& body1"]}>
              {OurRangeOfWinRARinfoData?.[0]?.bottomdesc}
            </Typography>
          </Box>
        </Box>
      </Box>
...
export default OurRangeOfWinRARServices;
