const styles = {
  containerCSS: {
    ...
    backgroundImage:
      "url('https://tech4logic-images.s3.ap-south-1.amazonaws.com/Images/Service/Seqrite_Bottom_BG.png')",
  ...
  contentConatiner: {
    ...
    "& button": {
      ...
      cursor: "pointer",
      alignItems: "center",
      boxShadow: "0px 0px 81.2px 0px #FA582D",
      padding: { xs: "8px 16px", md: "10px 20px" },
      justifyContent: "center",
      "&:hover": {
        background: "#EA4335",
        boxShadow: "0px 0px 81.2px 0px #EA4335",
      },
    },
  },
};
