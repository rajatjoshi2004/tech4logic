...
const OurRangeOfPaloaltoServices = ({ ourRangeOfPaloaltoinfoData }) => {
    ...
    >
      ...
      >
        ...
        >
          <Image
            src={
              "https://tech4logic-images.s3.ap-south-1.amazonaws.com/Images/Service/PaloaltoLogo.svg"
            }
            alt="Paloalto Logo"
            width={470}
            height={135}
      ...
      <Grid container spacing={3} sx={{ width: "100%", ml: { xs: 0 } }}>
        {ourRangeOfPaloaltoinfoData?.[0]?.PaloaltoCloudCard?.map((card, index, array) => (
          <Grid
            item
            xs={12}
      ...
      <Box sx={{ ...styles.BottomContainerCSS, mt: { xs: "40px", md: "60px" } }}>
        ...
        >
          <Box sx={{ ...styles.leftInfo, marginBottom: { xs: "20px", md: "0" } }}>
            ...
            >
              {ourRangeOfPaloaltoinfoData?.[0]?.title}
            </Typography>
            <Typography
              variant="h4"
              sx={{
          ...
          <Box sx={{ ...styles.rightInfo }}>
            <Typography variant="body1" sx={styles.rightInfo["& body1"]}>
              {ourRangeOfPaloaltoinfoData?.[0]?.subTitle}
            </Typography>
            <Typography variant="body1" sx={styles.rightInfo["& body1"]}>
              {ourRangeOfPaloaltoinfoData?.[0]?.description}
            </Typography>
            <Typography variant="body1" sx={styles.rightInfo["& body1"]}>
              {ourRangeOfPaloaltoinfoData?.[0]?.bottomdesc}
            </Typography>
          </Box>
        </Box>
      </Box>
...
export default OurRangeOfPaloaltoServices;
