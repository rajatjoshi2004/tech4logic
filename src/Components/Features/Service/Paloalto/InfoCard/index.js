...
const PaloaltoServiceInfoCard = ({ PaloaltoData }) => {
  return (
    <Box
      sx={{
        ...styles.containerCSS,
...
export default PaloaltoServiceInfoCard;
