...
const FortnetServiceInfoCard = ({ FortnetData }) => {
  return (
    <Box
      sx={{
        ...styles.containerCSS,
...
export default FortnetServiceInfoCard;
