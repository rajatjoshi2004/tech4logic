...
const OurRangeOfGoogleCloudServices = ({OurRangeOfGoogleinfoData}) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image
            src="https://tech4logic-images.s3.ap-south-1.amazonaws.com/Images/Service/Google_Cloud_Img.svg"
            alt="IBM Logo"
            width={470}
            height={135}
          />
      ...
      <Grid container spacing={3} sx={{ width: "100%", ml: { xs: 0 } }}>
        {OurRangeOfGoogleinfoData?.[0]?.GoogleCloudCard?.map((card) => (
          <Grid item xs={12} sm={6} md={4} lg={3} key={card?._id}  data-aos="zoom-in-up">
            ...
            >
              <Box sx={styles.logoContainer}>
                <Image
                  src="https://tech4logic-images.s3.ap-south-1.amazonaws.com/Images/Service/Google_Clod_White_logo.svg"
      ...
      <Box sx={{ ...styles.BottomContainerCSS, mt: { xs: "40px", md: "60px" } }}>
        ...
        >
          <Box sx={{ ...styles.leftInfo, marginBottom: { xs: "20px", md: "0" } }}>
            ...
            >
             {OurRangeOfGoogleinfoData?.[0]?.title}
            </Typography>
            <Typography
              variant="h4"
              sx={{
          ...
          <Box sx={{ ...styles.rightInfo }}>
            ...
            {OurRangeOfGoogleinfoData?.[0]?.description}
            </Typography>
            <Typography variant="body1" sx={styles.rightInfo["& body1"]}>
            {OurRangeOfGoogleinfoData?.[0]?.subTitle}
            </Typography>
            <Typography variant="body1" sx={styles.rightInfo["& body1"]}>
            {OurRangeOfGoogleinfoData?.[0]?.bottomdesc}
            </Typography>
          </Box>
        </Box>
      </Box>
...
export default OurRangeOfGoogleCloudServices;
