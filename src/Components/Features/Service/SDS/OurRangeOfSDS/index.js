...
const OurRangeOfDevelopmentCloudServices = ({ OurRangeSDSInfoData }) => {
    ...
    >
      <Box sx={{ ...styles.ConatinerCSS, textAlign: { xs: "center", md: "left" } }}>
        <Box sx={styles.titleConatiner}>
          ...
          >
            {OurRangeSDSInfoData?.[0]?.subTitle}
          </Typography>
        </Box>
        <Typography
          variant="body1"
        ...
        >
          {OurRangeSDSInfoData?.[0]?.description}
        </Typography>
      </Box>

      <Grid container spacing={3} sx={{ width: "100%", ml: { xs: 0 } }}>
        {OurRangeSDSInfoData?.[0]?.SDSCloudCard?.map((card) => (
          <Grid item xs={12} sm={6} md={4} lg={3} key={card._id} data-aos="zoom-in-up">
            ...
            >
              <Box sx={styles.logoContainer}>
                <Image
                  src="https://tech4logic-images.s3.ap-south-1.amazonaws.com/Images/Service/SDSWhite.svg"
                  alt="SDS Logo"
                  width={75}
                  height={16}
      ...
      <Box sx={{ ...styles.BottomContainerCSS, mt: { xs: "40px", md: "60px" } }}>
        ...
        >
          ...
          >
            {OurRangeSDSInfoData?.[0]?.bottomdesc}
          </Typography>
        </Box>
      </Box>
    </Box>
...
export default OurRangeOfDevelopmentCloudServices;
