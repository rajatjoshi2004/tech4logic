...
const OurRangeOfMicroSoft365CloudServices = ({ OurRangeOfMicroSoft365infoData }) => {
    ...
    >
      ...
      >
        ...
        >
          <Image
            src={
              "https://tech4logic-images.s3.ap-south-1.amazonaws.com/Images/Service/Microsoft_365_logo.svg"
            }
      ...
      <Grid container spacing={3} sx={{ width: "100%", ml: { xs: 0 } }}>
        {OurRangeOfMicroSoft365infoData?.[0]?.MicroSoft365CloudCard?.map((card) => (
      ...
      <Box sx={{ ...styles.BottomContainerCSS, mt: { xs: "40px", md: "60px" } }}>
        ...
        >
          <Box sx={{ ...styles.leftInfo, marginBottom: { xs: "20px", md: "0" } }}>
            ...
            >
              {OurRangeOfMicroSoft365infoData?.[0]?.title}
            </Typography>
            <Typography
              variant="h4"
              sx={{
          ...
          <Box sx={{ ...styles.rightInfo }}>
            <Typography variant="body1" sx={styles.rightInfo["& body1"]}>
              {OurRangeOfMicroSoft365infoData?.[0]?.subTitle}
            </Typography>
            <Typography variant="body1" sx={styles.rightInfo["& body1"]}>
              {OurRangeOfMicroSoft365infoData?.[0]?.description}
            </Typography>
            <Typography variant="body1" sx={styles.rightInfo["& body1"]}>
              {OurRangeOfMicroSoft365infoData?.[0]?.bottomdesc}
            </Typography>
          </Box>
        </Box>
      </Box>
...
export default OurRangeOfMicroSoft365CloudServices;
