...
const MicroSoft365ServiceInfoCard = ({ MicroSoft365Data }) => {
  return (
    <Box
      sx={{
        ...styles.containerCSS,
    ...
    >
      <Box sx={{ paddingX: { xs: "20px", md: "120px" }, mt: "50px" }}>
        ...
        >
          ...
          >
            <Image
              src={MicroSoft365Data?.[0]?.CardImage}
          ...
          >
            ...
            >
              {MicroSoft365Data?.[0]?.description}
            </Typography>
          </Box>
        </Box>
      </Box>
...
export default MicroSoft365ServiceInfoCard;
