...
const WhyMicroSoftTeamsComponent = ({ whyMicroSoftTeamsInfoData }) => {
  useEffect(() => {
    Aos.init({
      duration: 1000,
      easing: "ease-in-out",
  ...
  return (
    <Box sx={styles.containerCSS}>
      ...
      <Grid container spacing={6} justifyContent="center">
        {whyMicroSoftTeamsInfoData?.[0]?.MicroSoftTeamsCard?.map((card) => (
...
export default WhyMicroSoftTeamsComponent;
