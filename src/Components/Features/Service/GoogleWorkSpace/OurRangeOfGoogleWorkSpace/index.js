...
const OurRangeOfGoogleWorkspaceCloudServices = ({ OurRangeOfGoogleWorkSpaceinfoData }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image
            src="https://tech4logic-images.s3.ap-south-1.amazonaws.com/Images/Service/Google_Work_Service_Color.svg"
            alt="Google Work Space Logo"
            width={470}
            height={135}
          />
          <Typography
      ...
      <Grid container spacing={3} sx={{ width: "100%", ml: { xs: 0 } }}>
        {OurRangeOfGoogleWorkSpaceinfoData?.[0]?.GoogleWorkSpaceCloudCard?.map((card) => (
          <Grid item xs={12} sm={6} md={4} lg={3} key={card?._id} data-aos="zoom-in-up">
            ...
            >
              <Box sx={styles.logoContainer}>
                <Image
                  src="https://tech4logic-images.s3.ap-south-1.amazonaws.com/Images/Header/googleworkspace.png"
                  alt="Google Work Space Logo"
                  width={184}
                  height={40}
      ...
      <Box sx={{ ...styles.BottomContainerCSS, mt: { xs: "40px", md: "60px" } }}>
        ...
        >
          <Box sx={{ ...styles.leftInfo, marginBottom: { xs: "20px", md: "0" } }}>
            ...
            >
              {OurRangeOfGoogleWorkSpaceinfoData?.[0]?.title}
            </Typography>
            <Typography
              variant="h4"
              sx={{
          ...
          <Box sx={{ ...styles.rightInfo }}>
            ...
            {OurRangeOfGoogleWorkSpaceinfoData?.[0]?.subTitle}
            </Typography>
            <Typography variant="body1" sx={styles.rightInfo["& body1"]}>
              {OurRangeOfGoogleWorkSpaceinfoData?.[0]?.description}
            </Typography>
            <Typography variant="body1" sx={styles.rightInfo["& body1"]}>
              {OurRangeOfGoogleWorkSpaceinfoData?.[0]?.bottomdesc}
            </Typography>
          </Box>
        </Box>
      </Box>
...
export default OurRangeOfGoogleWorkspaceCloudServices;
